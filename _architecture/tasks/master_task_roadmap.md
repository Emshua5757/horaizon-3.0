...
| **TASK-011B** | `client_flutter` | Dart / Flutter | Native Telemetry & Interactive Terminal Screen (`/terminal`) | [x] Completed |
| **TASK-012** | `client_flutter` | Dart / Flutter | Settings Screen & Connection Quality Banner | [x] Completed |
